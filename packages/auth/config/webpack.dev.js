...
const devConfig = {
  mode: 'development',
  output: {
    publicPath: 'http://localhost:8082/', // this tells webpack where to put the bundled file when we run the build command
  },
  devServer: {
    port: 8082,
    historyApiFallback: {
  ...
  plugins: [
    new ModuleFederationPlugin({
      name: 'auth', // this is the name of the module
      filename: 'remoteEntry.js', // this is the file that will be generated by this module
      exposes: { 
        './AuthApp': './src/bootstrap', // this exposes the bootstrap file in the src directory
      },
