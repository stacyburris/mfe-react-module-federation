...
const prodConfig = {
  ...
  output: {
    ...
    publicPath: '/auth/latest/', // this tells webpack where to put the bundled file when we run the build command
  },
  plugins: [
    new ModuleFederationPlugin({
      name: 'auth', // this name is used by the container to reference this module
      filename: 'remoteEntry.js', // this is the file that the container will look at to see what our marketing module exposes
      exposes: {
        './AuthApp': './src/bootstrap', // this exposes the MarketingApp component found in src/bootstrap.js
      },
